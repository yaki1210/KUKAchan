...
export const ARMOR_PATCHES: PatchSpec[] = [
  ...
  { yaw0: -0.5, yaw1: 0.5, theta0: 0.78 + S, theta1: UB - BT, w: 18, h: 10 },
  { yaw0: -1.28, yaw1: -0.5 - S, theta0: 0.78 + S, theta1: UB - BT, w: 16, h: 10 },
  { yaw0: 0.5 + S, yaw1: 1.28, theta0: 0.78 + S, theta1: UB - BT, w: 16, h: 10 },

  { yaw0: -0.82, yaw1: -0.36, theta0: UB + BT, theta1: 1.94, w: 12, h: 16 },
  { yaw0: 0.36, yaw1: 0.82, theta0: UB + BT, theta1: 1.94, w: 12, h: 16 },
  { yaw0: -0.34, yaw1: 0.34, theta0: 1.88, theta1: LB - BT, w: 12, h: 6 },
  { yaw0: -1.28, yaw1: -0.82 - S, theta0: 1.42, theta1: LB - BT, w: 10, h: 12 },
  { yaw0: 0.82 + S, yaw1: 1.28, theta0: 1.42, theta1: LB - BT, w: 10, h: 12 },

  { yaw0: -0.9, yaw1: 0.9, theta0: LB + BT, theta1: 2.58, w: 22, h: 12 },
  { yaw0: -1.28, yaw1: -0.9 - S, theta0: LB + BT, theta1: 2.5, w: 8, h: 10 },
  { yaw0: 0.9 + S, yaw1: 1.28, theta0: LB + BT, theta1: 2.5, w: 8, h: 10 },

  { yaw0: -2.05, yaw1: -1.32, theta0: 0.42, theta1: UB - BT, w: 16, h: 16 },
  { yaw0: 1.32, yaw1: 2.05, theta0: 0.42, theta1: UB - BT, w: 16, h: 16 },
  { yaw0: -2.05, yaw1: -1.32, theta0: UB + BT, theta1: 2.52, w: 16, h: 16 },
  { yaw0: 1.32, yaw1: 2.05, theta0: UB + BT, theta1: 2.52, w: 16, h: 16 },
...
export function upperBandCurve(radius = BAND_R): THREE.CatmullRomCurve3 {
  ...
  for (let i = 0; i <= n; i++) {
    ...
    const theta = 1.245 + 0.018 * Math.cos(yaw);
    pts.push(crownLinePoint(yaw, theta, radius));
  }
