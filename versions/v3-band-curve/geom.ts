...
export const TEMPLE_DIR = { x: 0.78, y: 0.39, z: 0.5 };
...
/** Upper band: center lower (downward bulge), ends higher. */
export function upperTheta(yaw: number): number {
  ...
  return tMid + (tEnd - tMid) * s;
}

/** Lower band: center higher (upward bulge), ends a little lower. */
